        ...
        <div className="list" style={{ paddingTop: '72px' }}>
          ...
          <label htmlFor="img">
            <input
              ...
              autoFocus
            />
            <button htmlFor="img" onClick={(e) => {e.preventDefault(); document.getElementById('img').click()}}>
              Select Image
            </button>
          </label>
          <button
                  ...
                  <CardContent>
                    <Typography variant="body2" color="text.secondary">
                      {post.content}
                        ...
                        Created in {new Date(post.createdAt).toLocaleDateString()} by {post.author.firstName} {post.author.lastName}
                  </CardContent>
                  <button
                    type="submit"
